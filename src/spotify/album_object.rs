...
impl AlbumObject {
    pub fn new(album_type: AlbumType, total_tracks: i32, available_markets: Vec<String>, external_urls: spotify::ExternalUrlObject, href: String, id: String, images: Vec<spotify::ImageObject>, name: String, release_date: String, release_date_precision: ReleaseDatePrecision, r#type: Type, uri: String, artists: Vec<spotify::SimplifiedArtistObject>, tracks: spotify::PagingSimplifiedTrackObject, copyrights: Vec<spotify::CopyrightObject>, external_ids: spotify::ExternalIdObject, genres: Vec<String>, label: String, popularity: i32) -> AlbumObject {
        AlbumObject {
            ...
            copyrights,
            external_ids: Box::new(external_ids),
            genres,
            label,
            popularity,
        }
