...
pub struct EpisodeObject {
    ...
    pub restrictions: Option<Box<spotify::EpisodeRestrictionObject>>,
    /// The show on which the episode belongs. 
    #[serde(rename = "show")]
    pub show: Box<spotify::SimplifiedShowObject>,
}

impl EpisodeObject {
    pub fn new(audio_preview_url: Option<String>, description: String, html_description: String, duration_ms: i32, explicit: bool, external_urls: spotify::ExternalUrlObject, href: String, id: String, images: Vec<spotify::ImageObject>, is_externally_hosted: bool, is_playable: bool, languages: Vec<String>, name: String, release_date: String, release_date_precision: ReleaseDatePrecision, r#type: Type, uri: String, show: spotify::SimplifiedShowObject) -> EpisodeObject {
        EpisodeObject {
            audio_preview_url,
            description,
            html_description,
